      ...
      <div class="authentication-wrapper authentication-cover">
        ...
        <div class="authentication-inner row m-0">
          ...
          <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-5 pb-2">
            <img
              src="<?= base_url() ?>public/dashboard/assets/img/illustrations/auth-reset-password-illustration-light.png"
              class="auth-cover-illustration w-100"
              alt="auth-illustration"
              data-app-light-img="illustrations/auth-reset-password-illustration-light.png"
              data-app-dark-img="illustrations/auth-reset-password-illustration-dark.png" />
            <img
              src="<?= base_url() ?>public/dashboard/assets/img/illustrations/auth-cover-reset-password-mask-light.png"
          ...
          <div
            ...
            <div class="w-px-400 mx-auto pt-5 pt-lg-0">
              ...
              <form id="formAuthentication" class="mb-3" action="<?php echo base_url() ?>updatepassword/<?= $id ?>" method="POST">
                  ...
                  <div class="input-group input-group-merge">
                    <div class="form-floating form-floating-outline">
                      <input
                        type="password"
                        id="password"
                        class="form-control <?= session()->getFlashdata('errors') && isset(session()->getFlashdata('errors')['password']) ? 'is-invalid' : '' ?>" value="<?= old('password') ?>"
                        name="password"
                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                  ...
                  <div class="input-group input-group-merge">
                    <div class="form-floating form-floating-outline">
                      <input
                        type="password"
                        id="confirmPassword"
                        class="form-control <?= session()->getFlashdata('errors') && isset(session()->getFlashdata('errors')['confirmPassword']) ? 'is-invalid' : '' ?>" value="<?= old('confirmPassword') ?>"
