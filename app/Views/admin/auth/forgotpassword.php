    ...
    <div class="position-relative">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner py-4">
            ...
            <div class="card-body mt-2">
              ...
              <?php if (session()->getFlashdata('errors')): ?>
                    ...
                    <?php endif; ?>
                     ...
                     <!-- Display reset link if it's available -->
                     <?php if ($resetLink = session()->getFlashdata('resetLink')): ?>
                        <p><strong>Click here to reset your password:</strong> <a href="<?= esc($resetLink) ?>" target="_blank">Reset Password</a></p>
                    <?php endif; ?>


              <form id="formAuthentication" class="mb-3" action="<?= base_url('forgotpassword') ?>"  method="POST">
                <div class="form-floating form-floating-outline mb-3">
                  <input
                    type="text"
                    class="form-control <?= session()->getFlashdata('errors') && isset(session()->getFlashdata('errors')['email']) ? 'is-invalid' : '' ?>" value="<?= old('email') ?>"
                    id="email"
                    name="email"
          ...
          <img
            alt="mask"
            src="<?= base_url() ?>public/dashboard/assets/img/illustrations/auth-basic-forgot-password-mask-light.png"
