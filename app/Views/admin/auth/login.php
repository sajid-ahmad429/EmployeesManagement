...
<html
  ...
  <head>
    ...
    <title>Login Cover - Pages | Admin Dashboard - Employee & Department</title>
    ...
    <div class="authentication-wrapper authentication-cover">
      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-5 pb-2">
          <img
            src="<?= base_url() ?>/public/dashboard/assets/img/illustrations/auth-login-illustration-light.png"
            class="auth-cover-illustration w-100"
            alt="auth-illustration"
            data-app-light-img="illustrations/auth-login-illustration-light.png"
            data-app-dark-img="illustrations/auth-login-illustration-dark.png" />
          <img
            src="<?= base_url() ?>/public/dashboard/assets/img/illustrations/auth-cover-login-mask-light.png"
        ...
        <div
          ...
          <div class="w-px-400 mx-auto pt-5 pt-lg-0">
            <h4 class="mb-2">Welcome to Admin Dashboard - Employee & Department! 👋</h4>
            ...
            <form id="formAuthentication" class="mb-3" action="<?= base_url('sysCtrlLogin') ?>"  method="POST">
              ...
              <div class="mb-3 d-flex justify-content-between">
                ...
                <a href="<?= base_url('forgotpassword') ?>" class="float-end mb-1">
